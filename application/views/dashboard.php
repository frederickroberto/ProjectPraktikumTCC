...
<head>
    ...
    <style>
        .overview-item--custom1,
        .overview-item--custom2,
        .au-card--custom {
            background-color: #000;
            color: #fff;
        }

        .overview-item--custom1 .icon,
        .overview-item--custom2 .icon,
        .au-card--custom .icon {
            color: #fff;
        }
                    ...
                    <div class="container-fluid">
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="col-sm-6 col-lg-6">
                                <div class="overview-item overview-item--custom1">
                            ...
                            <div class="col-sm-6 col-lg-6">
                                <div class="overview-item overview-item--custom2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                        ...
                        <div class="row m-t-25">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="au-card au-card--custom m-b-40">
